            ...
            <div class="card w-100">
                ...
                <div class="modal fade" id="TambahData" tabindex="-1" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="TambahDataModalLabel">Tambah Satuan Barang</h5>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="data-jenis" width="120%"  class="table table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
                            <thead>
                                <tr>
